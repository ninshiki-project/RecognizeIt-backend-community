...
class ResetUserCredentialForAdminAccessNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject("{$this->appName}: Password Reset Request - Your Temporary Password")
            ->greeting("Dear {$notifiable->name},")
            ->line("You have requested a password reset. If you didn\'t request a password reset, please ignore this email.")
            ->line('This email contains your temporary password:')
            ->line('')
